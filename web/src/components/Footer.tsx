        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link to="/publish" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  Publier un projet
                </Link>
              </li>
              <li>
                <Link to="/artisan/dashboard" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  Espace Artisan
                </Link>
              </li>
              <li>
