  ...
  return (
    <footer className="bg-gray-900 text-white w-full">
      <div className="w-full px-4 md:px-6 lg:px-8 py-8 md:py-10 lg:py-12">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 md:mb-6 max-w-md text-sm md:text-base leading-relaxed">
              Trouvez l'artisan idéal pour vos travaux. Service gratuit, artisans vérifiés, 
              devis sous 24h. Votre projet de rénovation commence ici.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm md:text-base">
                  Accueil
                </Link>
              </li>
              <li>
                <Link to="/publish" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm md:text-base">
                  Publier un projet
                </Link>
              </li>
              <li>
                <Link to="/artisan/dashboard" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm md:text-base">
                  Espace Artisan
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm md:text-base">
                  Connexion
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-2 text-gray-300 text-sm md:text-base">
              <li className="flex items-center space-x-2">
                ...
                <span>contact@travaux-excellence.fr</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-purple-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-6 md:mt-8 pt-4 md:pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <div className="text-gray-400 text-xs md:text-sm">
              © 2024 TRAVAUX EXCELLENCE. Tous droits réservés.
            </div>
